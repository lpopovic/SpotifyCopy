...
class PlaylistViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let gesture = UILongPressGestureRecognizer(target: self, action: #selector(didLongPressCollectionView(_:)))
    ...
    @objc private func didLongPressCollectionView(_ gesture: UILongPressGestureRecognizer) {
